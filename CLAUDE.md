...
- **`docs/engine.md`** is the hardware, not the design: the three memory
  ...
  that have already cost this project time (twenty-seven of them now). **Read it before adding a
...
menu's JUMP page reaches the RECORD, THE MARGINS and the DIPLOMA without playing to them. It is
