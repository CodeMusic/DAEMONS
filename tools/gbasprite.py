...
OW_DEFERRED = {"pidgey", "pikachu", "jigglypuff", "nidoran_f", "nidoran_m", "clefairy", "psyduck", "voltorb", "machop", "meowth", "cubone", "fearow", "pidgeot", "slowpoke", "wigglytuff"}   # batches 2-6 add thirteen, same census owed
