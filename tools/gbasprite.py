...
OW_DEFERRED = {"pidgey", "pikachu", "jigglypuff", "nidoran_f", "nidoran_m", "clefairy", "psyduck", "voltorb", "machop", "meowth", "cubone", "fearow", "pidgeot", "slowpoke", "wigglytuff", "doduo", "chansey", "kangaskhan"}   # batches 2-8 add sixteen, same census owed
