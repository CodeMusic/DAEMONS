#!/usr/bin/env python3
"""T-131 batch 7: BLIGHT's drafts are coloured, and greying the DRAFT made its pale flower match the background,
...
grey_but_markers("gfx/drafts/batch7/clean/blight_front.png")
grey_but_markers("gfx/drafts/batch7/clean/blight_back.png")
