#!/usr/bin/env python3
"""T-131 batch 9: STARR's concept redraw is brown, which the accent shift broke into a mottle of magenta and dark purple;
...
grey_but_markers("gfx/drafts/batch9/clean/starr_front.png")
grey_but_markers("gfx/drafts/batch9/clean/starr_back.png")
