...
| **T-34** | **`WIP — main`.** **The starter names are placeholders.** *2.7a retyped the three and 4.26 named thirty-two others around them, so they are now the least finished names in the game* — **and they are the first three the player reads** | `engineGba`, species | 8.2 |
