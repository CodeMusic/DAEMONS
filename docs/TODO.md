...
| **T-25** | **`FIGHTING DOJO` is a place name carrying a vanilla type word**, in six lines across four maps and on the town sign. *Found doing T-07 and left there deliberately:* **a building's name is 3's decision, not 1.2's**, and the class inside it is already `FORMALIST` | `engineGba`, Brazen | T-07, 3 |
