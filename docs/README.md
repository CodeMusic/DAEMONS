...
|---|---|---|
| [`vision.md`](vision.md) | **The living design bible.** Every decision, including reversed ones and the reasoning behind them. Updated as work proceeds. | v11.0, working |
| [`CONTEXT-CONTENT-design-bible-v11.0.pdf`](CONTEXT-CONTENT-design-bible-v11.0.pdf) | Typeset **snapshot** at v11.0. Current. | frozen |
