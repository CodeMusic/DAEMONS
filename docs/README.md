...
|---|---|---|
| [`vision.md`](vision.md) | **The living design bible.** Every decision, including reversed ones and the reasoning behind them. Updated as work proceeds. | v11.215, working |
| [`CONTEXT-CONTENT-design-bible-v11.215.pdf`](CONTEXT-CONTENT-design-bible-v11.215.pdf) | Typeset **snapshot** at v11.215 — the port, the bestiary, the harness, the fable cast, and the streaks. Cut a new one with `./docs/build-pdf.sh 11.215` (the script adds the `v`). | frozen |
