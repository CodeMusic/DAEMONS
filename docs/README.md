...
|---|---|---|
| [`vision.md`](vision.md) | **The living design bible.** Every decision, including reversed ones and the reasoning behind them. Updated as work proceeds. | v11.47, working |
| [`CONTEXT-CONTENT-design-bible-v11.1.pdf`](CONTEXT-CONTENT-design-bible-v11.1.pdf) | Typeset **snapshot** at v11.1. Superseded — cut a new one with `./docs/build-pdf.sh 11.47`. | frozen |
