...
|---|---|---|
| [`vision.md`](vision.md) | **The living design bible.** Every decision, including reversed ones and the reasoning behind them. Updated as work proceeds. | v10.8, working |
| [`CONTEXT-CONTENT-design-bible-v10.8.pdf`](CONTEXT-CONTENT-design-bible-v10.8.pdf) | Typeset **snapshot** at v10.8. Current. | frozen |
