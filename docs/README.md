...
|---|---|---|
| [`vision.md`](vision.md) | **The living design bible.** Every decision, including reversed ones and the reasoning behind them. Updated as work proceeds. | v11.222, working |
| [`CONTEXT-CONTENT-design-bible-v11.222.pdf`](CONTEXT-CONTENT-design-bible-v11.222.pdf) | Typeset **snapshot** at v11.222 — the port, the bestiary, the harness, the fable cast, the streaks, every animation redrawn, the Index mark that is now the chart, and which instrument draws whom. Cut a new one with `./docs/build-pdf.sh 11.222` (the script adds the `v`). | frozen |
