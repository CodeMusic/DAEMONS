...
|---|---|---|
| [`vision.md`](vision.md) | **The living design bible.** Every decision, including reversed ones and the reasoning behind them. Updated as work proceeds. | v11.204, working |
| [`CONTEXT-CONTENT-design-bible-v11.204.pdf`](CONTEXT-CONTENT-design-bible-v11.204.pdf) | Typeset **snapshot** at v11.204 — the port, the bestiary and the harness. Cut a new one with `./docs/build-pdf.sh 11.204` (the script adds the `v`). | frozen |
