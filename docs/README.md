...
|---|---|---|
| [`vision.md`](vision.md) | **The living design bible.** Every decision, including reversed ones and the reasoning behind them. Updated as work proceeds. | v11.220, working |
| [`CONTEXT-CONTENT-design-bible-v11.220.pdf`](CONTEXT-CONTENT-design-bible-v11.220.pdf) | Typeset **snapshot** at v11.220 — the port, the bestiary, the harness, the fable cast, the streaks, every animation redrawn, and the two tools that drew it as daemons. Cut a new one with `./docs/build-pdf.sh 11.220` (the script adds the `v`). | frozen |
